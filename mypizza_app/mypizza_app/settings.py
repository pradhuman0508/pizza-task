"""
Django settings for mypizza_app project.
...
SECRET_KEY = 'django-insecure-ap!mxz7wqg-v7ntnvg963*ri@o$ilql$w77nl$(ucs7i9u&io6'
...
WSGI_APPLICATION = 'mypizza_app.wsgi.application'
